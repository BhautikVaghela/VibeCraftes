...
import EducationalServicesPage from './pages/EducationalServicesPage';
...
type Page = 'home' | 'about' | 'businesses' | 'educational-services' | 'residential-events' | 'news' | 'news-detail' | 'contact' | 'admin-login' | 'admin-dashboard';
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'educational-services':
        return <EducationalServicesPage onNavigate={handleNavigate} />;
