import { ArrowRight, Briefcase, Sparkles, Users, Gift, Megaphone, Lightbulb, GraduationCap } from 'lucide-react';
  ...
  const businesses = [
    {
      ...
      description:
        'Complete wedding planning and execution services including venue selection, décor design, entertainment, catering, photography, guest hospitality, and destination wedding arrangements with customizable packages.',
      color: 'blue',
    },
    {
      icon: GraduationCap,
      ...
      description:
        'Annual day ceremonies, convocations, cultural programs, freshers & farewell parties, school carnivals, seminars, student engagement activities, and educational tours with professional event management.',
      color: 'green',
    },
    {
      icon: Briefcase,
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Comprehensive event solutions spanning corporate excellence, wedding planning, educational services, and brand activation
          </p>
        </div>
          ...
          {businesses.map((business, index) => (
            ...
            >
              ...
              <div className="p-6 md:p-7">
                ...
                <button
                  onClick={() => {
                    if (business.title === 'Wedding Planner') {
                      onNavigate('residential-events');
                    } else if (business.title === 'Educational Services') {
                      onNavigate('educational-services');
                    } else {
